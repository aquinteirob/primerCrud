		...
		while (menu != 5) {
			...
			if (menu == 1) {
				...
				case 1:
					...
					/*se usa un bucle for en el cual, a cada valor que se muestra por pantalla pide confirmación de si es el que se busca
					 en caso de que no se imprimer el siguiente valor*/ 
				case 2:
				...
				case 1:
					...
					break;
				//Utilización de un bucle for para mostrar todos los valores posibles, distintos de null, de la búsqueda por color
				case 2:
